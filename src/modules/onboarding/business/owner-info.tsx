  ...
  return (
    <Container maxW={{ lg: '100%', sm: '90%', base: '100%' }}>
      ...
      >
          ...
          >
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <FormControl mb={6}>
                ...
                <Select {...register('nationality')} placeholder="Select">
              ...
              >
                <GridItem colSpan={2}>
                  <FormControl>
                    ...
                    <Select {...register('phone_type')} placeholder="Select">
        ...
        <Box px={6}>
          <Flex justifyContent={'center'} gap={4}>
            <Button colorScheme="gray" w="50%" onClick={onBack}>
              Back
            </Button>
            <Button colorScheme="blue" w="50%" onClick={onContinue}>
              Continue
            </Button>
          </Flex>
        </Box>
