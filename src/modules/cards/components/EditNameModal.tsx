...
const EditNameModal = ({ isOpen, onClose }: ApplicationCollabType) => {
    return (
            ...
            <ModalContent p={10}>
                <ModalHeader alignItems={"center"} gap={2} px={0} pt={0} pb={8} display={"flex"}>
                    <Flex gap={2} alignItems={"center"}>
                        <CardIcon />
                        <Heading fontSize={"xl"} color={"Primary.Navy"}>Edit Nickname</Heading>
                    </Flex>
                </ModalHeader>
                <ModalCloseButton />
                <ModalBody p={0}>
                    <FormControl>
                        ...
                        <Input type="text" placeholder="Office Card" />
                    </FormControl>
                </ModalBody>
