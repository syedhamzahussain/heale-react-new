import { Box, Flex, Grid, Heading, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Progress, Text, Tooltip, useDisclosure } from '@chakra-ui/react'
import ButtonTheme from 'modules/shared/ButtonTheme'
import { CardIcon, HealeLogoWhite, WifiIcon } from 'modules/shared/Icons'
import React, { useState } from 'react'
import { ApplicationCollabType } from 'type'
import ResetCardPinModal from './ResetCardPinModal'
...
const CardDetailModal = ({ isOpen, onClose }: ApplicationCollabType) => {
    ...
    return (
        <>
            <Modal size={"xl"} isOpen={isOpen} onClose={onClose} isCentered>
                ...
                <ModalContent p={10}>
                    ...
                    <ModalBody p={0}>
                        ...
                        <Flex mt={8} gap={2}>
                            <ButtonTheme small btnText='Reset PIN' chakraProps={{
            ...
            <ResetCardPinModal isOpen={isOpenResetModal} onClose={onCloseResetModal} />
        </>
    )
}
